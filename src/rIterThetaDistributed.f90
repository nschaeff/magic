...
! !          end if
! ! 
! !          call spat_to_SH_dist(this%gsa_dist%Advr, this%nl_lm%AdvrLM)
! !          call spat_to_SH_dist(this%gsa_dist%Advt, this%nl_lm%AdvtLM)
! !          call spat_to_SH_dist(this%gsa_dist%Advp, this%nl_lm%AdvpLM)
! ! 
! !          if ( this%lRmsCalc .and. l_mag_LF .and. this%nR>n_r_LCR ) then
! !             ! LF treated extra:
! !             call spat_to_SH_dist(this%gsa_dist%LFr, this%nl_lm%LFrLM)
! !             call spat_to_SH_dist(this%gsa_dist%LFt, this%nl_lm%LFtLM)
! !             call spat_to_SH_dist(this%gsa_dist%LFp, this%nl_lm%LFpLM)
! !          end if
! !       end if
! !       if ( (.not.this%isRadialBoundaryPoint) .and. l_heat ) then
! !          call spat_to_SH_dist(this%gsa_dist%VSr, this%nl_lm%VSrLM)
! !          call spat_to_SH_dist(this%gsa_dist%VSt, this%nl_lm%VStLM)
! !          call spat_to_SH_dist(this%gsa_dist%VSp, this%nl_lm%VSpLM)
! ! 
! !          if (l_anel) then ! anelastic stuff
! !             if ( l_mag_nl .and. this%nR>n_r_LCR ) then
! !                call spat_to_SH_dist(this%gsa_dist%ViscHeat, this%nl_lm%ViscHeatLM)
! !                call spat_to_SH_dist(this%gsa_dist%OhmLoss, this%nl_lm%OhmLossLM)
! !             else
! !                call spat_to_SH_dist(this%gsa_dist%ViscHeat, this%nl_lm%ViscHeatLM)
! !             end if
! !          end if
...
! !          call spat_to_SH_dist(this%gsa_dist%VPr, this%nl_lm%VPrLM)
! !       end if
! !       if ( (.not.this%isRadialBoundaryPoint) .and. l_chemical_conv ) then
! !          call spat_to_SH_dist(this%gsa_dist%VXir, this%nl_lm%VXirLM)
! !          call spat_to_SH_dist(this%gsa_dist%VXit, this%nl_lm%VXitLM)
! !          call spat_to_SH_dist(this%gsa_dist%VXip, this%nl_lm%VXipLM)
! !       end if
! !       if ( l_mag_nl ) then
! !          if ( .not.this%isRadialBoundaryPoint .and. this%nR>n_r_LCR ) then
! !             call spat_to_SH_dist(this%gsa_dist%VxBr, this%nl_lm%VxBrLM)
! !             call spat_to_SH_dist(this%gsa_dist%VxBt, this%nl_lm%VxBtLM)
! !             call spat_to_SH_dist(this%gsa_dist%VxBp, this%nl_lm%VxBpLM)
! !          else
! !             call spat_to_SH_dist(this%gsa_dist%VxBt, this%nl_lm%VxBtLM)
! !             call spat_to_SH_dist(this%gsa_dist%VxBp, this%nl_lm%VxBpLM)
! !          end if
...
! !          call spat_to_sphertor(this%gsa_dist%dpdtc, this%gsa_dist%dpdpc, this%nl_lm%PFt2LM, this%nl_lm%PFp2LM)
! !          call spat_to_sphertor(this%gsa_dist%CFt2, this%gsa_dist%CFp2, this%nl_lm%CFt2LM, this%nl_lm%CFp2LM)
! !          if ( l_conv_nl ) then
! !             call spat_to_sphertor(this%gsa_dist%Advt2, this%gsa_dist%Advp2, this%nl_lm%Advt2LM, this%nl_lm%Advp2LM)
! !          end if
! !          if ( l_mag_nl .and. this%nR>n_r_LCR ) then
! !             call spat_to_sphertor(this%gsa_dist%LFt2, this%gsa_dist%LFp2, this%nl_lm%LFt2LM, this%nl_lm%LFp2LM)
! !          end if
! !       end if
! !       PERFOFF
! !       
